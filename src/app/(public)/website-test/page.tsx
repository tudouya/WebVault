...
// 将第一个网站数据转换为详情格式进行测试
function convertToDetailData(website: any): WebsiteDetailData {
  return {
    ...website,
    ...
    // 模拟统计数据
    stats: {
      total_visits: website.visit_count || 0,
      monthly_visits: Math.floor((website.visit_count || 0) * 0.3),
      weekly_visits: Math.floor((website.visit_count || 0) * 0.1),
      daily_visits: Math.floor((website.visit_count || 0) * 0.02),
