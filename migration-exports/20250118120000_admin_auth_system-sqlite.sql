...
-- ============================================================================
-- 
-- This file was automatically converted from PostgreSQL DDL
-- Conversion performed by: scripts/migration/convert-ddl.ts
-- Conversion date: 2025-08-22T02:59:40.097Z
-- 
-- Important notes:
-- - PostgreSQL-specific features have been removed or simplified
-- - Enum types are converted to comments (use CHECK constraints)
-- - Functions and triggers are not supported in SQLite
-- - UUID types are stored as TEXT
-- - JSONB types are stored as TEXT
-- - Complex CHECK constraints may be simplified
-- 
-- ============================================================================;
...
-- SKIPPED: ALTER TABLE auth_lockouts ENABLE ROW LEVEL SECURITY;
...
-- SKIPPED: GRANT SELECT ON user_profiles TO anon, authenticated;

-- SKIPPED: GRANT SELECT, INSERT, UPDATE ON auth_lockouts TO authenticated;

-- Grant execute permissions on functions
GRANT EXECUTE ON FUNCTION record_auth_failure(VARCHAR) TO authenticated;

-- SKIPPED: GRANT EXECUTE ON FUNCTION is_email_locked(VARCHAR) TO authenticated;

-- SKIPPED: GRANT EXECUTE ON FUNCTION reset_auth_lockout(VARCHAR) TO authenticated;

-- SKIPPED: GRANT EXECUTE ON FUNCTION cleanup_auth_lockouts() TO authenticated;
